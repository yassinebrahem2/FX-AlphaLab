"""ECB Collector - Bronze Layer (Raw News & Sentiment Data Collection).
...
Example:
    ...
    >>>
    >>> collector = ECBCollector(output_dir=Path("data/raw/news/ecb"))
...
class ECBCollector(DocumentCollector):
    ...
    def __init__(
        ...
        self.logger.info(
            "ECBCollector initialized, output_dir=%s",
            self.output_dir,
        )
